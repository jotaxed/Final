...
public interface ju extends IInterface {
    ...
    public static abstract class a extends Binder implements ju {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    d a = a(com.google.android.gms.dynamic.d.a.ap(data.readStrongBinder()), data.readInt(), data.readInt());
