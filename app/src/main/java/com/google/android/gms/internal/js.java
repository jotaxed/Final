...
public interface js extends IInterface {
    ...
    public static abstract class a extends Binder implements js {
        ...
        public static js P(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.common.internal.IGmsCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof js)) ? new a(iBinder) : (js) queryLocalInterface;
        }
