...
public final class Polygon {
    ...
    public Polygon(m delegate) {
        this.amw = (m) jx.i(delegate);
    }
    ...
    public boolean equals(Object other) {
        ...
        try {
            return this.amw.a(((Polygon) other).amw);
