...
public interface dy extends IInterface {
    ...
    public static abstract class a extends Binder implements dy {
        ...
        public static dy s(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof dy)) ? new a(iBinder) : (dy) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder b = b(com.google.android.gms.dynamic.d.a.ap(data.readStrongBinder()));
