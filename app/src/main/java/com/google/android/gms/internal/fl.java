...
public interface fl extends IInterface {
    ...
    public static abstract class a extends Binder implements fl {
        ...
        private static class a implements fl {
            ...
            public fj b(fh fhVar) throws RemoteException {
                ...
                try {
                    ...
                    fj i = obtain2.readInt() != 0 ? fj.CREATOR.i(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return i;
                } catch (Throwable th) {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    fj b = b(data.readInt() != 0 ? fh.CREATOR.h(data) : null);
    ...
    fj b(fh fhVar) throws RemoteException;
}
