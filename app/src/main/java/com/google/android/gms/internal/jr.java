...
public interface jr extends IInterface {
    ...
    public static abstract class a extends Binder implements jr {
        ...
        public static jr O(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.common.internal.ICancelToken");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof jr)) ? new a(iBinder) : (jr) queryLocalInterface;
        }
