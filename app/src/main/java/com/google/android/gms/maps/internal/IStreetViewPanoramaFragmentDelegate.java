...
public interface IStreetViewPanoramaFragmentDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IStreetViewPanoramaFragmentDelegate {
        ...
        private static class a implements IStreetViewPanoramaFragmentDelegate {
            ...
            public IStreetViewPanoramaDelegate getStreetViewPanorama() throws RemoteException {
                ...
                try {
                    ...
                    IStreetViewPanoramaDelegate br = com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate.a.br(obtain2.readStrongBinder());
                    return br;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void getStreetViewPanoramaAsync(u callback) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    onInflate(com.google.android.gms.dynamic.d.a.ap(data.readStrongBinder()), data.readInt() != 0 ? StreetViewPanoramaOptions.CREATOR.cY(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                ...
                case 12:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    getStreetViewPanoramaAsync(com.google.android.gms.maps.internal.u.a.bo(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void getStreetViewPanoramaAsync(u uVar) throws RemoteException;
